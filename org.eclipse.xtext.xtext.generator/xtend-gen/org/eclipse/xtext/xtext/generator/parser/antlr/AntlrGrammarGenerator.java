...
public class AntlrGrammarGenerator extends AbstractAntlrGrammarWithActionsGenerator {
  ...
  protected String compileParserImports(final Grammar it, final AntlrOptions options) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("import ");
    String _name_2 = this._grammarAccessExtensions.getASTConversion(it).getName();
  ...
  protected String compileParserMembers(final Grammar it, final AntlrOptions options) {
    ...
    _builder.append(" \t");
    _builder.append("private ");
    String _simpleName_1 = this._grammarAccessExtensions.getASTConversion(it).getSimpleName();
    ...
    String _simpleName_2 = this.naming.getInternalParserClass(it).getSimpleName();
    ...
    _builder.append(" grammarAccess, ");
    String _simpleName_4 = this._grammarAccessExtensions.getASTConversion(it).getSimpleName();
    ...
    String _simpleName_5 = this._grammarAccessExtensions.getGrammarAccess(it).getSimpleName();
    ...
    _builder.append("   \t");
    _builder.append("protected ");
    String _simpleName_6 = this._grammarAccessExtensions.getASTConversion(it).getSimpleName();
