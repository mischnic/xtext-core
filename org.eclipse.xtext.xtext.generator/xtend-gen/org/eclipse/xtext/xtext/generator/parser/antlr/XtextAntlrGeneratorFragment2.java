    ...
    GeneratedJavaFileAccess _xblockexpression = null;
    {
      ...
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.append("\t");
          _builder.append("private ");
          TypeReference _aSTConversion = XtextAntlrGeneratorFragment2.this.grammarUtil.getASTConversion(XtextAntlrGeneratorFragment2.this.getGrammar());
          _builder.append(_aSTConversion, "\t");
          _builder.append(" astConversion;");
          _builder.newLineIfNotEmpty();
          _builder.newLine();
          _builder.append("\t");
          ...
          _builder.append("(stream, getGrammarAccess(), getASTConversion());");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("}");
          _builder.newLine();
          ...
          _builder.append("\t");
          _builder.append("public ");
          TypeReference _aSTConversion_1 = XtextAntlrGeneratorFragment2.this.grammarUtil.getASTConversion(XtextAntlrGeneratorFragment2.this.getGrammar());
          _builder.append(_aSTConversion_1, "\t");
          _builder.append(" getASTConversion() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          _builder.append("return this.astConversion;");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("}");
          _builder.newLine();
          _builder.newLine();
          _builder.append("\t");
          _builder.append("public void setASTConversion(");
          TypeReference _aSTConversion_2 = XtextAntlrGeneratorFragment2.this.grammarUtil.getASTConversion(XtextAntlrGeneratorFragment2.this.getGrammar());
          _builder.append(_aSTConversion_2, "\t");
          _builder.append(" astConversion) {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          _builder.append("this.astConversion = astConversion;");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("}");
          _builder.newLine();
