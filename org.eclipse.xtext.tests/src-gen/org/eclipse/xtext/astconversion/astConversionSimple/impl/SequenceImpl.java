 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.astconversion.astConversionSimple.impl.SequenceImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceImpl extends MinimalEObjectImpl.Container implements Sequence
{
  ...
  {
    return AstConversionSimplePackage.Literals.SEQUENCE;
  }
  ...
  public EList<Sequence> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<Sequence>(Sequence.class, this, AstConversionSimplePackage.SEQUENCE__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AstConversionSimplePackage.SEQUENCE__EXPRESSIONS:
