...
public class XtextParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XtextGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParserRuleAccess().getGroup_1_1_2(), "rule__ParserRule__Group_1_1_2__0");
			...
			builder.put(grammarAccess.getBecomesDeclGeneratedClassAccess().getGroup_1(), "rule__BecomesDeclGeneratedClass__Group_1__0");
			builder.put(grammarAccess.getBecomesDeclGeneratedClassAccess().getGroup_1_2(), "rule__BecomesDeclGeneratedClass__Group_1_2__0");
			builder.put(grammarAccess.getBecomesDeclManualClassAccess().getGroup(), "rule__BecomesDeclManualClass__Group__0");
			builder.put(grammarAccess.getBecomesDeclManualClassAccess().getGroup_1(), "rule__BecomesDeclManualClass__Group_1__0");
			builder.put(grammarAccess.getBecomesDeclManualClassAccess().getGroup_1_2(), "rule__BecomesDeclManualClass__Group_1_2__0");
			builder.put(grammarAccess.getBecomesDeclCustomAttributeAccess().getGroup(), "rule__BecomesDeclCustomAttribute__Group__0");
			...
			builder.put(grammarAccess.getParserRuleAccess().getBecomesAssignment_1_1_2_1(), "rule__ParserRule__BecomesAssignment_1_1_2_1");
			...
			builder.put(grammarAccess.getBecomesDeclAccess().getListAssignment_0_0(), "rule__BecomesDecl__ListAssignment_0_0");
			builder.put(grammarAccess.getBecomesDeclAccess().getListTypeAssignment_0_1(), "rule__BecomesDecl__ListTypeAssignment_0_1");
			builder.put(grammarAccess.getBecomesDeclAccess().getDescriptorAssignment_1(), "rule__BecomesDecl__DescriptorAssignment_1");
			builder.put(grammarAccess.getBecomesDeclAccess().getCodeAssignment_2(), "rule__BecomesDecl__CodeAssignment_2");
			builder.put(grammarAccess.getBecomesDeclGeneratedClassAccess().getAttributesAssignment_1_1(), "rule__BecomesDeclGeneratedClass__AttributesAssignment_1_1");
			builder.put(grammarAccess.getBecomesDeclGeneratedClassAccess().getAttributesAssignment_1_2_1(), "rule__BecomesDeclGeneratedClass__AttributesAssignment_1_2_1");
			builder.put(grammarAccess.getBecomesDeclManualClassAccess().getTypeAssignment_0(), "rule__BecomesDeclManualClass__TypeAssignment_0");
			builder.put(grammarAccess.getBecomesDeclManualClassAccess().getAttributesAssignment_1_1(), "rule__BecomesDeclManualClass__AttributesAssignment_1_1");
